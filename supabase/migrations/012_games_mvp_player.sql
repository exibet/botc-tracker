-- Add mvp_player_id to games table
ALTER TABLE games
  ADD COLUMN mvp_player_id UUID REFERENCES profiles(id);

-- Backfill from existing game_players.is_mvp
UPDATE games g
SET mvp_player_id = (
  SELECT gp.player_id
...
-- Update trigger to also set games.mvp_player_id
